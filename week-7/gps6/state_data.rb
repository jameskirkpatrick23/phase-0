...
#STATEDATA holds all the state information. The original key is utilized as the state names, specifically in strings. That key is mapped to the values held at two symbols: population density and population. Those are also keys themselves as they hold float and integer information
# :Population_Density
# "Alabama" "ALABAMA"
# .upcase() .reverse()
# [][] .fetch()
